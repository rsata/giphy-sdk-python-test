...
from giphy._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from giphy._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, make_request_options
...
class TestGiphy:
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"GIPHY_API_KEY": Omit()}):
            client2 = Giphy(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/gifs").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.get("/gifs", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}})
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/gifs").mock(return_value=httpx.Response(500))
...
class TestAsyncGiphy:
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"GIPHY_API_KEY": Omit()}):
            client2 = AsyncGiphy(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await self.client.get("/gifs", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}})
